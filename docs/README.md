...
3. [`decisions/2026-07-25-kanban-vnext-ownership-and-lifecycle.md`](./decisions/2026-07-25-kanban-vnext-ownership-and-lifecycle.md)
   for the accepted vNext task-generation, ownership, fencing, submission, and promotion boundaries.
4. [`zmx-session-names.md`](./zmx-session-names.md) for the durable zmx session-name contract shared with external tooling.
